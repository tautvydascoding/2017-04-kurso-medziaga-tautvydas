...
// uzduotis2: Liuto klasei susikurti privatu kintamaji "Name".
// ir uskurti 2 funkcijas jo reiksmei pakeisti ir paimti "setName($x)", "getName()".
...
// 2) User klase turi kintamuosius : username, password, rights irfunkcija Login($name, $pass)
// 3) Admin klase funkcijas: changeUserName($nm), changeRights($rgt)


class User {
    public $username = "Tim";
    protected $rights = "moderator";
